<%-- 
    Document   : index
    Created on : 24 mai 2016, 15:36:07
    Author     : cdi207
--%>
...
<html class="no-js">
    ...
    <section id="hero-area">
      <img class="img-responsive" src="client-template/images/header.jpg" alt="">
    </section>
                ...
                <div class="col-md-4">
                    <div class="block wow fadeInLeft"  data-wow-delay="1100ms">
                        <div class="gallary">
                            ...
                            <ul>
                                <li>
                                    <a href="#"><img src="client-template/images/photo/photo-1.jpg" alt=""></a>
                                </li>
                                <li>
                                    <a href="#"><img src="client-template/images/photo/photo-2.jpg" alt=""></a>
                                </li>
                                <li>
                                    <a href="#"><img src="client-template/images/photo/photo-3.jpg" alt=""></a>
                                </li>
                                <li>
                                    <a href="#"><img src="client-template/images/photo/photo-4.jpg" alt=""></a>
                                </li>
                            </ul>
                        </div>
